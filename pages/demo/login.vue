...
<template>
  <form class="space-y-4 md:space-y-6" @submit.prevent="onSubmit">
    <div>
      ...
      <input type="email" v-model="email" v-bind="emailAttrs" name="email" id="email" :class="[
    ...
    <div>
      ...
      <input type="password" v-model="password" v-bind="passwordAttrs" name="password" id="password" :class="[
        'bg-gray-50 border sm:text-sm rounded-lg block w-full p-2.5',
        'focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500',
    ...
    <button :disabled="isLoading" type="submit"
      ...
      <svg v-if="isLoading" aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin"
